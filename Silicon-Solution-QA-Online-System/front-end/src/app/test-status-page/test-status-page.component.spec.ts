...
import { MatSnackBar, MatInputModule, MatProgressBarModule, MatSelectModule, MatPaginatorModule, 
    ...
    MatToolbarModule, MatAutocompleteModule, MatCheckboxModule, MatDatepickerModule} from '@angular/material';
...
describe('Unit test for detailed info dialog component', () => {
    ...
    let dialogSpy: jasmine.SpyObj<MatDialogRef<TestStatusPageComponent>>;
    ...
    beforeEach(async(()=>{
        ...
        TestBed.configureTestingModule({
            imports: [FormsModule, ReactiveFormsModule, MatInputModule, MatProgressBarModule, MatPaginatorModule,MatDatepickerModule,
